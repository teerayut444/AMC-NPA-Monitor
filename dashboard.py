...
if selected_page == "🔮 แผนภาพวงกลม NPA ภาพรวม":
    ...
    # Add a beautiful, single-line gradient title above the chart
    st.markdown("""
    <div style="text-align: center; margin-top: 5px; margin-bottom: 20px;">
        <h2 style="font-weight: 700; color: #0f172a; margin: 0; font-size: 1.8rem; background: linear-gradient(to right, #4f46e5, #0d9488); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">🔮 Overview AMC NPA: แผนภาพความสำเร็จการกวาดข้อมูล (3D Glossy Bubble Chart)</h2>
    </div>
    """, unsafe_allow_html=True)
